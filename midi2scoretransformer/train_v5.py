...
from dataset_v4 import ASAPDataset
from dataset_v4 import UnpairedXMLDataset
...
def main():
    ...
    parser.add_argument("--unpaired_list", type=str, default="", help="txt file, each line is an unpaired MusicXML path")
    ...
    parser.add_argument(
        ...
        help="How much XML-derived surrogate MIDI information to use for unpaired data",
    )
